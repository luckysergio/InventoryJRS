...
class ProductDistributorResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'jenis' => $this->whenLoaded('jenis', fn() => ['id' => $this->jenis->id, 'nama' => $this->jenis->nama]),
            'type' => $this->whenLoaded('type', fn() => ['id' => $this->type->id, 'nama' => $this->type->nama]),
            'bahan' => $this->whenLoaded('bahan', fn() => ['id' => $this->bahan->id, 'nama' => $this->bahan->nama]),
            'distributor' => $this->whenLoaded('distributor', fn() => ['id' => $this->distributor->id, 'nama' => $this->distributor->nama]),
