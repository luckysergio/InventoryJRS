...
export const useInventories = (params = {}) => {
  ...
  return useQuery({
    ...
    // ✅ FIXED: HAPUS keepPreviousData - ini yang bikin UI "flash back" ke data lama
    // saat refetch terjadi, yang override optimistic update
    staleTime: 30 * 1000, // 30 detik (inventory sering berubah)
...
export const useCreateProductMovement = () => {
  ...
  return useMutation({
    ...
    onSettled: async (_data, error) => {
      ...
      // ✅ FIXED: Naikkan delay jadi 1000ms untuk pastikan backend selesai bump cache
