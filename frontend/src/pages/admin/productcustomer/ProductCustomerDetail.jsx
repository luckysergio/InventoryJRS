...
import { X, User, Tag, Pencil, Image as ImageIcon, ChevronLeft, ChevronRight, ZoomIn, FileText } from "lucide-react";
        ...
        <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl overflow-hidden animate-modalIn ring-1 ring-black/5 max-h-[85vh] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar">
            ...
            <div className="px-5 py-4 space-y-2">
              ...
              <InfoItem icon={Tag} iconBg="bg-emerald-100" iconColor="text-emerald-600" label="Harga" value={formatRupiah(selectedItem.harga)} />
