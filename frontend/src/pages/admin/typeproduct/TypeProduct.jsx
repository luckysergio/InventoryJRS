        ...
        <div className="flex flex-col items-center gap-1.5 w-full">
          ...
          <div
            className={cn(
              ...
              hasProducts ? "bg-emerald-50 text-emerald-700" : "bg-slate-100 text-slate-500"
            )}
          >
...
// ============================================
// LOADING SKELETON (20 items match perPage)
// ============================================
    ...
    <div className="flex flex-col items-center gap-4">
      ...
      <div>
        ...
        {isFilterActive ? (
          ...
          >
            <Plus className="w-4 h-4" /> Tambah Type Pertama
          </button>
        )}
      </div>
    </div>
