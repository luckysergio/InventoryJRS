...
const FEATURES = [
  {
    ...
    description: 'Setiap produk melewati quality control ketat untuk memastikan daya tahan dan performa terbaik di lapangan.',
    color: 'from-emerald-500 to-teal-600',
  },
  {
    icon: Factory,
    title: 'Harga Pabrik Langsung',
    description: 'Dapatkan harga kompetitif langsung dari produsen tanpa perantara, hemat biaya operasional industri Anda.',
    color: 'from-blue-500 to-indigo-600',
  },
  {
    icon: Truck,
    title: 'Pengiriman Cepat',
    description: 'Stok selalu ready dan pengiriman cepat ke seluruh Indonesia dengan packaging aman dan terjamin.',
    color: 'from-orange-500 to-red-600',
  },
  {
    icon: HeadphonesIcon,
    title: 'Support 24/7',
    description: 'Tim teknis kami siap membantu konsultasi dan after-sales service kapan pun Anda membutuhkan.',
    color: 'from-purple-500 to-pink-600',
  },
  {
    icon: Award,
    title: 'Produk Bersertifikat',
    description: 'Material karet berkualitas tinggi yang telah memenuhi standar industri nasional dan internasional.',
    color: 'from-amber-500 to-yellow-600',
  },
  {
    icon: Cog,
    title: 'Custom Order',
    description: 'Melayani pembuatan rubber seal custom sesuai spesifikasi dan dimensi khusus kebutuhan proyek Anda.',
...
const PROCESS_STEPS = [
  {
    number: 1,
    title: 'Konsultasi',
    description: 'Hubungi tim kami via WhatsApp atau telepon untuk mendiskusikan kebutuhan rubber seal Anda.',
    icon: MessageSquare,
  },
  {
    number: 2,
    title: 'Penawaran',
    description: 'Kami berikan penawaran harga terbaik beserta spesifikasi produk yang sesuai kebutuhan.',
    icon: FileCheck,
  },
  {
    number: 3,
    title: 'Konfirmasi',
    description: 'Setelah deal, lakukan pembayaran dan kami segera proses pesanan Anda dengan cepat.',
    icon: ClipboardCheck,
  },
  {
    number: 4,
    title: 'Pengiriman',
    description: 'Produk dikirim dengan packaging aman ke alamat Anda di seluruh Indonesia.',
    icon: PackageCheck,
  },
];
...
const TESTIMONIALS = [
  {
    ...
    content: 'Kualitas O-Ring dari Jaya Rubber Seal sangat bagus dan tahan lama. Sudah 3 tahun jadi supplier utama kami dan belum pernah mengecewakan.',
    rating: 5,
    initials: 'BS',
  },
  {
    name: 'Ir. Hartono',
    role: 'Plant Engineer',
    company: 'PT. Auto Parts Indonesia',
    content: 'Respons cepat, harga bersaing, dan produk selalu ready stock. Sangat membantu kelancaran produksi kami. Recommended!',
    rating: 5,
    initials: 'IH',
  },
  {
    name: 'Siti Rahayu',
    role: 'Owner',
    company: 'Bengkel Maju Motor',
    content: 'Pelayanan ramah dan bisa custom sesuai kebutuhan bengkel saya. Pengiriman juga cepat sampai ke Surabaya. Terima kasih Jaya Rubber Seal!',
    rating: 5,
    initials: 'SR',
  },
];
...
const FAQ_ITEMS = [
  {
    ...
    answer: 'Kami menyediakan berbagai material karet seperti NBR (Nitrile), Viton (FKM), Silicone, EPDM, Natural Rubber, dan Neoprene. Setiap material memiliki karakteristik khusus untuk aplikasi yang berbeda, dan tim kami siap membantu Anda memilih yang paling sesuai.',
  },
  {
    question: 'Apakah bisa order custom sesuai ukuran khusus?',
    answer: 'Ya, kami melayani pembuatan rubber seal custom sesuai gambar teknis atau sampel yang Anda berikan. Minimum order bervariasi tergantung kompleksitas produk. Silakan hubungi tim kami untuk konsultasi lebih lanjut.',
  },
  {
    question: 'Berapa lama waktu pengiriman?',
    answer: 'Untuk produk ready stock, pengiriman dilakukan dalam 1-2 hari kerja. Untuk area Jakarta dan sekitarnya biasanya sampai dalam 1 hari, sedangkan luar pulau 2-5 hari tergantung lokasi dan jasa ekspedisi yang dipilih.',
  },
  {
    question: 'Apakah ada garansi untuk produk yang dijual?',
    answer: 'Ya, semua produk kami memiliki garansi kualitas. Jika terdapat cacat produksi atau tidak sesuai spesifikasi, kami akan melakukan penggantian tanpa biaya tambahan. Garansi tidak berlaku untuk kesalahan pemilihan material atau kerusakan akibat pemakaian.',
  },
  {
    question: 'Bagaimana cara melakukan pemesanan?',
    answer: 'Anda bisa memesan melalui WhatsApp, email, atau datang langsung ke toko kami di Glodok Jaya. Cukup berikan informasi jenis produk, ukuran, material, dan jumlah yang dibutuhkan. Tim kami akan segera memberikan penawaran harga.',
  },
  {
    question: 'Apakah melayani pembelian satuan atau hanya grosir?',
    answer: 'Kami melayani pembelian baik satuan (eceran) maupun grosir (partai besar). Untuk pembelian dalam jumlah besar, kami menawarkan harga khusus yang lebih kompetitif. Hubungi kami untuk mendapatkan penawaran terbaik.',
  },
];
...
const HeroSection = () => {
  ...
  return (
    <section 
      id="home" 
      className="relative pt-6 sm:pt-10 lg:pt-16 pb-14 lg:pb-20 overflow-hidden bg-gradient-to-br from-white via-brand-50 to-ocean-50"
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          <div data-aos="fade-right">
            ...
            <h1 
              id="hero-heading"
              className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold leading-tight text-slate-900 mb-5 text-balance"
            >
              Solusi{' '}
            ...
            <div className="relative aspect-square max-w-md lg:max-w-lg mx-auto">
              ...
              <div className="relative w-full h-full rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-brand-100 to-ocean-100 flex items-center justify-center">
                ...
                <div className="relative z-10 text-center p-6">
                  {logoFailed ? (
                    <div 
                      className="w-32 h-32 sm:w-40 sm:h-40 mx-auto mb-4 rounded-full bg-gradient-to-br from-brand-500 to-ocean-500 flex items-center justify-center shadow-2xl" 
                      role="img" 
                      aria-label="Logo Jaya Rubber Seal"
                    >
              ...
              <div 
                className="absolute -top-3 -left-3 sm:-top-4 sm:-left-4 bg-white rounded-2xl shadow-xl p-3 sm:p-4 flex items-center gap-3 animate-float" 
                data-aos="fade-down" 
                data-aos-delay="400"
                role="status"
                aria-label="Berpengalaman lebih dari 15 tahun"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-emerald-100 flex items-center justify-center flex-shrink-0" aria-hidden="true">
              ...
              <div 
                className="absolute -bottom-3 -right-3 sm:-bottom-4 sm:-right-4 bg-white rounded-2xl shadow-xl p-3 sm:p-4 flex items-center gap-3 animate-float" 
              ...
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-amber-100 flex items-center justify-center flex-shrink-0" aria-hidden="true">
              ...
              <div 
                className="absolute top-1/2 -right-4 lg:-right-8 bg-white rounded-2xl shadow-xl p-3 sm:p-4 hidden sm:flex items-center gap-3 animate-float" 
                style={{ animationDelay: '0.5s' }} 
                data-aos="fade-left" 
                data-aos-delay="800"
                role="status"
                aria-label="Lebih dari 1000 pelanggan"
              >
                <div className="w-12 h-12 rounded-xl bg-brand-100 flex items-center justify-center flex-shrink-0" aria-hidden="true">
        ...
        {STATS.map((stat, idx) => {
          ...
          return (
            <div key={stat.label} className="text-center group" data-aos="fade-up" data-aos-delay={idx * 100}>
              ...
              <p className="text-3xl lg:text-4xl font-display font-black text-gradient mb-1" aria-label={stat.ariaLabel}>
                {stat.value}
              </p>
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      {FEATURES.map((feature, idx) => {
        ...
        return (
          <article 
            key={feature.title} 
            className="group relative bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-slate-100" 
            data-aos="fade-up" 
...
/* ==========================================
   CATEGORIES SECTION - FIXED IDENTICAL LINKS
   ========================================== */
  ...
  return (
    <Section id="products" title="Produk Terlaris Kami" subtitle="Pilihan Terbaik" background="light">
            ...
            >
              <div className="relative aspect-square bg-gradient-to-br from-brand-50 to-ocean-50 overflow-hidden">
                {product.foto_depan_url || product.foto_depan ? (
                  <img 
                    src={product.foto_depan_url || `${ASSET_URL}/storage/${product.foto_depan}`} 
                ...
                {product.rank && (
                  <div 
                    className="absolute top-3 left-3 w-10 h-10 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 text-white font-bold flex items-center justify-center shadow-lg" 
                    aria-label={`Peringkat ${product.rank}`}
                  >
                    #{product.rank}
                  </div>
                )}
      ...
      <div className="text-center mt-10" data-aos="fade-up">
        <Link 
          to="/products" 
          className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white border-2 border-brand-200 text-brand-700 font-semibold hover:bg-brand-50 hover:border-brand-300 transition-all focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2"
          aria-label="Lihat semua produk rubber seal"
        >
          Lihat Semua Produk
          <ArrowRight size={18} aria-hidden="true" />
        </Link>
  ...
  <Section id="testimonials" title="Apa Kata Pelanggan Kami" subtitle="Testimoni" background="light">
    <div className="grid md:grid-cols-3 gap-6">
      {TESTIMONIALS.map((t, idx) => (
        <blockquote 
          key={t.name} 
          className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-slate-100 relative" 
          data-aos="fade-up" 
        ...
        >
          ...
          <footer className="flex items-center gap-3 pt-4 border-t border-slate-100">
            <div 
              className="w-12 h-12 rounded-full bg-gradient-to-br from-brand-500 to-ocean-500 flex items-center justify-center text-white font-bold flex-shrink-0" 
              aria-hidden="true"
            >
              {t.initials}
            </div>
...
/* ==========================================
   FAQ SECTION - FIXED HEADING ORDER
   ========================================== */
    ...
    <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden hover:border-brand-300 transition-colors" data-aos="fade-up" data-aos-delay={index * 50}>
      <h3 className="m-0">
        <button 
          ...
          className="w-full px-5 sm:px-6 py-4 flex items-center justify-between gap-4 text-left hover:bg-slate-50 transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-brand-500" 
        ...
        >
          ...
          <ChevronDown 
            size={20} 
            className={cn('flex-shrink-0 text-brand-500 transition-transform', isOpen && 'rotate-180')} 
            aria-hidden="true" 
          />
        </button>
      </h3>
      ...
      >
        <div className="px-5 sm:px-6 pb-4 text-sm text-slate-700 leading-relaxed">
          {item.answer}
        </div>
      </div>
    </div>
    ...
    <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center">
      <div className="max-w-3xl mx-auto" data-aos="zoom-in">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <a 
            href="https://wa.me/6281287951140?text=Halo%20Jaya%20Rubber%20Seal%2C%20saya%20ingin%20memesan%20produk" 
            target="_blank" 
            rel="noopener noreferrer" 
            ...
            aria-label="Chat WhatsApp untuk memesan produk"
          >
        ...
        <address className="mt-10 flex flex-wrap items-center justify-center gap-6 text-white text-sm not-italic">
          <a 
            ...
            className="flex items-center gap-2 hover:text-white/90 transition-colors focus:outline-none focus:ring-2 focus:ring-white rounded px-2 py-1"
            aria-label="Hubungi telepon +62 21 62305916"
          >
          ...
          <a 
            ...
            className="flex items-center gap-2 hover:text-white/90 transition-colors focus:outline-none focus:ring-2 focus:ring-white rounded px-2 py-1"
            aria-label="Kirim email ke sales.jayarubberseal@gmail.com"
          >
